$Id: README.txt,v 1.5 2006/11/28 13:37:34 jpr5 Exp $

Program: fishermanfilter
...
Description:
  ...
  fishermanfilter strives to provide most of GNU grep's common features,
  applying them to the network layer.  fishermanfilter is a pcap-aware tool that
...
Usage: fishermanfilter <LhNXViwqpevxlDtTRM> <-IO pcap_dump> <-n num> <-d dev> <-A num>
...
Tips:
  ...
  o When sniffing interfaces that are very busy or are seeing large
    ...
    limit what PCAP has to deliver to fishermanfilter.  The fishermanfilter parser takes a
  ...
  o As of v1.28, fishermanfilter doesn't require a match expression.  However,
    there are cases where fishermanfilter can be confused and think part of your
    bpf filter is the match expression, as in:

  % fishermanfilter not port 80
  ...
  Please see http://fishermanfilter.sourceforge.net/usage.html for more detailed
  examples describing fishermanfilter usage.


Miscellany:

  Please see the ``doc/CREDITS.txt'' file for a listing of the people
  who helped make fishermanfilter what it is today.  Also, please note that
  fishermanfilter is released under a BSD-style license, though it currently
...
Support, Feedback, & Patches
  ...
  submit a patch, please visit fishermanfilter's project at SourceForge and use
  ...
  fishermanfilter Project Website:
