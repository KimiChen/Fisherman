...
# Output:
# 
#      ./fishermanfilterped.Rulename1
#      ./fishermanfilterped.Rulename2
#      ./fishermanfilterped.Rulename3
#
# Considerations:
#
...
sub go {
	...
	system("zcat $rule{'file'} | " .
               "fishermanfilter -qtI - $rule{'regex'} $rule{'filter'} 2&>1 > " .
               "fishermanfilterped.$rule_name");
...
print "Hi, I'm fishermanfilterper, and here we go.\n";
