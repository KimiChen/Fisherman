/*
 * $Id: fishermanfilter.c,v 1.93 2006/11/28 13:38:43 jpr5 Exp $
 *
...
#if HAVE_DLT_IEEE802_11_RADIO
    if (radiotap_present) {
        uint16_t radio_len = ((struct fishermanfilter_rtaphdr_t *)(p))->it_len;
